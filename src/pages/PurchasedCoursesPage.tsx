...
import "../styles/purchasedCoursesPage.scss";
...
const PurchasedCoursesPage = () => {
  return (
    <Section id="purchased-courses-page">
      <Heading>
        <h2>دوره های خریداری شده</h2>
      </Heading>
      <div className="purchased-courses-container">
        <nav className="purchased-courses-container-sidebar">
        ...
        <div className="purchased-courses-container-content">
          {datas.map((data) => (
            <Link to={`/courses/${data.title}`} key={data.id}>
